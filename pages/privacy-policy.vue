...
<div>
	<h1><as-title-text/></h1>
	<p>This privacy policy sets out how the Da-Lee Group uses and protects any
	information that you give the Da-Lee Group when you use this website.</p>

	<p>The Da-Lee Group is committed to ensuring that your privacy is protected.
	...
	<p>The Da-Lee Group may change this policy from time to time by updating this
	page. You should check this page from time to time to ensure that you are happy
	with any changes.</p>
	...
	<li>work experience or history</li>
	<li>personal information such as preferences and interests</li>
	<li>other information relevant to the stated purpose for which we have asked for information</li>
	</ol>

	<h2>2. What we do with the information we gather</h2>

	<p>We require this information for the following reasons:</p>

	<ol>
	<li>Internal record keeping.</li>
	<li>We may use the information to improve our products and services.</li>
	<li>We may periodically send promotional emails about new products, special offers or other information which we think you may find interesting using the email address which you have provided.</li>
	<li>To use your information to contact you for potential employment purposes. We may contact you by email, phone, fax or mail.</li>
	</ol>
	...
	<p>A cookie is a small file which asks permission to be placed on your
	...
	<p>We may use traffic log cookies to identify which pages are being used. This
	helps us analyze data about web page traffic and improve our website in order to
	tailor it to customer needs. We only use this information for statistical
	analysis purposes and then the data is removed from the system. </p>

	<p>Overall, cookies help us provide you with a better website, by enabling us to
	...
	data you choose to share with us. </p>
	...
	<p>Our website may contain links to other websites of interest. However, once
	...
	parties unless we have your permission or are required by law to do so.</p>
	</div>
</template>
