 ...
 * @Last Modified time: 2018-01-18 18:07:41
 */
...
$checkedRegardingOptions = implode(
	"\n"
	, array_map('prefixWithDash', $post->checkedRegardingOptions)
);
...
$mail->Subject = html_entity_decode(implode(', ', $post->checkedRegardingOptions));
$mail->Body = <<<EOT
